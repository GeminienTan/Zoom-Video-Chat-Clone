...
$(".menu a i").on("click", function() {
    ...
    $(".filterSchedule").not(".all").hide("3000"), $(".filterSchedule").not(".all").hide("3000"), $(".filterScheduleBtn").click(function() {
        var t = $(this).attr("data-filter");
        $(".filterSchedule").not("." + t).hide("3000"), $(".filterSchedule").filter("." + t).show("3000")
    })
}), $(document).ready(function() {
    ...
    $("#schedules").on("keyup", function() {
        var t = $(this).val().toLowerCase();
        $("#agendas a").filter(function() {
            $(this).toggle($(this).text().toLowerCase().indexOf(t) > -1)
        })
    })
}), $(document).ready(function() {
